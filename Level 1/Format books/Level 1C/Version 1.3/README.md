...
![Level 1C product placement](images/L1C_scope.png "Level 1C product")
...
| ----------- | ----------------------------- |
| properties.product.ancestry   | A list of references comprising the inputs used to create the product. Details include product IDs, product types, properties, software names and versions. 
...
| ----------- | ----------------------------- |
| `descriptor.generationDate`   | `descriptor.generationDate`  |
| `sensors[ ].images[ ].geometric.dimensions` | `sensors[ ].images[ ].geometric.imageDimensions` |
| `sensors[ ].images[ ].geometric.resolution` | `sensors[ ].images[ ].geometric.spatialResolution` |
...
| Property        | Description           |
| ----------- | ----------------------------- |
| properties.processingBaseline    | A string containing the processing baseline (algorithm) version   |
| properties.eo:cloud_cover  | A number containing an estimate of cloud cover as a percentage. See STAC EO Extension documentation on GitHub. |
...
For more information about the contents of this file, refer to our [online documentation.](https://github.com/pinkmatter/farearth-docs/blob/main/Level%201/Format%20books/Level%201C/Version%201.3/TILE_INFO_V1_3.md)
...
For more information about the contents of this file, refer to our [online documentation.](https://github.com/pinkmatter/farearth-docs/blob/main/Level%201/Format%20books/Level%201C/Version%201.3/POINTING_V1_3.md)
